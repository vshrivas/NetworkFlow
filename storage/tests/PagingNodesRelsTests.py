...
''' This test creates several nodes and relationships and makes sure their read and written
values are correct. If no assertions fail, the test functions as expected. '''
