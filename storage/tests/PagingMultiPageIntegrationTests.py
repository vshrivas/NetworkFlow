...
Checks to make sure that nodes and relationships read at each stage are correct. Set 
DataPage.MAX_PAGE_ENTRIES back to 1, to force paging to occur.
If no assertions fail, test behaves as expected. '''
